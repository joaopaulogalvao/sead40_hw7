//
//  MyQuestionsStackOverFlowService.m
//  sead40_hw7
//
...
@implementation MyQuestionsStackOverFlowService
...
+(void)myAskedQuestions:(void (^)(NSArray *, NSError *))completionHandler{
  ...
  [manager GET:url parameters:nil success:^void(AFHTTPRequestOperation * operation, id responseObject) {
    ...
    NSArray *questions = [MyQuestionsJSONParser myQuestionsResultsFromJSON:responseObject];
